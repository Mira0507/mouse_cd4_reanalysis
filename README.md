## Reanalysis of STAR vs HISAT2 vs Salmon 

### 1. Raw data and alignment 

#### See [GitHub repo](https://github.com/Mira0507/mouse_cd4)

### 2. Change from the initial analysis 

#### - Conda environment 

#### - DESeq2=1.30.1 was installed (instead of 1.30.0)

#### - Other major packages are the same as the original analysis
...
dependencies:
  ...
  - bioconductor-ensembldb=2.14.0=r40_0
  ...
  - bioconductor-protgenerics=1.22.0=r40_0
  ...
  - bioconductor-seqc=1.24.0=r40_0
  ...
  - r-data.table=1.13.4=r40hcfec24a_0
  ...
  - r-matrixstats=0.58.0=r40hcfec24a_0
