...
title: "Adjusted P-Value Analysis in mouse CD4-positive T cells"
author: "Mira Sohn" 
---
...
filename <- "m.padj_difference_SA_ST.csv"


# Import data
diff.low <- fread(filename)[1:50, -1][, Group := "Low % Difference"]
diff.high <- tail(fread(filename), 50)[, -1][, Group := "High % Difference"]
